...
import { Config, Env, Nested, NESTED_METADATA } from "../decorators";

const dbLoggingOptionsSchema = z.enum([
  "query",
  "error",
  "schema",
  "warn",
...
class PostgreConfig {
  ...
  @Env("DB_POSTGREDB_DATABASE")
  database: string = "user_table";
...
export class DatabaseConfig {
   ...
   */
  get isLegacyPostgreSql() {
    return this.type === "postgresdb" && this.postgresdb.poolSize == 0;
  }
